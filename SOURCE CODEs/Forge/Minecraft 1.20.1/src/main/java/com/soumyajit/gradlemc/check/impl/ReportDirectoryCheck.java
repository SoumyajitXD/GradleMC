    ...
    public List<CheckResult> run(CheckContext context) {
        ...
        try {
            ...
            return List.of(CheckResult.of(
                    ...
                    writable ? "Reports can be exported here." : "Check file permissions for the Minecraft config directory."
            ));
            ...
            return List.of(CheckResult.of(
                    ...
                    "Check file permissions for the Minecraft config directory."
            ));
        }
    }
}
