package com.soumyajit.gradlemc.quilt;
...
public final class GradleMCQuilt implements ModInitializer {
    @Override
    public void onInitialize(ModContainer mod) {
        ...
        GradleMC.LOGGER.info("GradleMC Quilt 1.20.1 initialized as {}", mod.metadata().id());
    }
}
