...
public record GradleMCGuiState(
    ...
    private static final String MOD_VERSION = QuiltLoader.getModContainer(GradleMC.MOD_ID)
    ...
    private static final String LOADER_VERSION = QuiltLoader.getModContainer("quilt_loader")
            .map(container -> container.metadata().version().raw())
            .orElse("");
