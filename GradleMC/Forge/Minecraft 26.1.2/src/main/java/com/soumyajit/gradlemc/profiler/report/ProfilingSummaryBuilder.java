...
public final class ProfilingSummaryBuilder {
    ...
    private static ModAttribution classify(String packageName, long samples) {
        ...
        if (lower.startsWith("net.minecraftforge") || lower.startsWith("cpw.mods")) {
            return new ModAttribution("Forge internals", "HIGH", samples, packageName);
        }
    ...
    private static final class GradleMCVersion {
        private static String lookup() {
            return ModList.getModContainerById(GradleMC.MOD_ID)
