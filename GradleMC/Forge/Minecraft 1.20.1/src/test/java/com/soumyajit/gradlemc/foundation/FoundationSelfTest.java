...
public final class FoundationSelfTest {
 ...
 private static TaskCore.Definition task(String id,List<TaskId> deps){return new TaskCore.Definition(TaskId.of(id),id,"test",deps,TaskCore.Affinity.CALLER_SAFE,Duration.ofSeconds(1),TaskCore.CachePolicy.PROCESS_LIFETIME,c->TaskCore.Availability.present(),c->new TaskCore.Output(List.of(),"ok"));}
