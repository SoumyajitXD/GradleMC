...
public final class GradleMCNetwork {
    ...
    public static void register() {
        ...
        PayloadTypeRegistry.playS2C().register(OpenGradleMCGuiPacket.TYPE, OpenGradleMCGuiPacket.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(SyncSmartAIStatusPacket.TYPE, SyncSmartAIStatusPacket.STREAM_CODEC);
        PayloadTypeRegistry.playC2S().register(RequestSmartAIStatusPacket.TYPE, RequestSmartAIStatusPacket.STREAM_CODEC);
