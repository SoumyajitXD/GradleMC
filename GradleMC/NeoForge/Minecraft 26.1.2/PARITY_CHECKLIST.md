# GradleMC NeoForge 26.1.2 Parity Checklist

Baseline references:

- `C:\MinecraftJavaMods\GradleMC\GradleMCFabric26.1.2`
- `C:\MinecraftJavaMods\GradleMC\GradleMCForge26.1.2`
...
- Metadata/version output: Gradle properties, `neoforge.mods.toml` expansion, manifest attributes, commands, GUI, reports, issue bundles, and profiler summaries align on NeoForge 26.1.2.
...
- `clean`, `compileJava`, `processResources`, `build`, and available `check`/test tasks must pass under JDK 25.
