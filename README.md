...
| Quilt | `1.0.0` | `gradlemc-quilt-1.20.1-1.0.0.jar` | `1.20.1` | `17` | Quilt `1.20.1` release |
...
- Not a public support claim for NeoForge, Bedrock, or any loader/version pair not listed in the supported release table.
